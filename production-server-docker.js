...
const pool = new Pool({
  connectionString: 'postgresql://postgres:postgres@whatsapp_postgres:5432/whatsapp_ordering'
});
...
// Start server
app.listen(PORT, () => {
  console.log('🚀 WhatsApp Ordering System - Production API (Docker Network)');
  console.log('==========================================================');
  ...
  console.log('==========================================================');
  console.log('✅ Production API with real database connection via Docker network');
